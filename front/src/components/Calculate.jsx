...
const Calculate = ({ show, handleClose, coin }) => {
    ...
    const calculateProfit = async()=>{
        const { data }  = await axios.post("http://localhost:3001/api/get_balance", datos)
    ...
    const downloadCsv = async(obj)=>{
        ...
        const { data } = await axios.post("http://localhost:3001/api/csv", { json: obj }, {
            responseType: 'blob'
        })
    ...
    const downloadJson = async(obj)=>{
        const { data } = await axios.post("http://localhost:3001/api/json", { json: obj }, {
            responseType: 'blob'
        })
